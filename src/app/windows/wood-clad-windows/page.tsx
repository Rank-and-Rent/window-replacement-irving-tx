...
export const metadata: Metadata = {
  ...
  description: 'Premium wood clad replacement windows in Irving, TX. Real wood interior beauty with durable exterior protection. Everything priced including installation.',
  keywords: 'wood clad windows Irving TX, wood clad replacement windows, traditional windows, Andersen wood clad windows, Pella wood clad windows',
}

export default function WoodCladWindowsPage() {
  const content = {
    title: 'Wood Clad Windows Replacement in Irving, TX',
    subtitle: 'Authentic Wood Interior Beauty with Weather-Resistant Exterior Protection',
    heroImage: '/window-types/wood-clad-irving-tx.jpg',

    intro: "Irving homeowners seeking the ultimate combination of traditional wood beauty and modern durability discover that wood clad windows provide the perfect balance. With authentic wood interiors that bring natural warmth to your home and weather-resistant exteriors that withstand Irving&apos;s challenging climate, wood clad windows represent the gold standard in window performance and aesthetics.",
    ...
    sections: [
      ...
      {
        heading: 'Weather Protection for Irving Climate',
        content: "The exterior cladding creates an impenetrable barrier against moisture, UV exposure, and temperature extremes that damage traditional wood windows in Irving. Unlike bare wood that requires annual maintenance, clad exteriors need minimal care while providing decades of weather protection. The cladding prevents rot, warping, and insect damage that plague unprotected wood in Texas climate.",
      },
      {
        heading: 'Superior Energy Efficiency',
        content: "Wood\&apos;s natural insulating properties combined with modern cladding technology create exceptional thermal performance. Wood clad windows typically achieve U-factors of 0.25-0.30, significantly better than aluminum and comparable to premium vinyl. Irving homeowners see 30-40% reductions in energy costs compared to older windows, with the added benefit of wood\&apos;s thermal mass that moderates temperature swings.",
      },
      {
        heading: 'Design Flexibility and Customization',
        content: "Wood clad windows offer unlimited design possibilities. The wood interior accepts any stain or paint color, matching Irving homes from traditional to contemporary styles. Exterior cladding is available in dozens of factory-finished colors that never need repainting. The combination allows homeowners to achieve perfect aesthetic harmony inside and out.",
      },
      {
        heading: 'Premium Quality and Longevity',
        content: "Wood clad windows represent the premium tier of window construction. Quality manufacturers use rot-resistant wood species, advanced cladding systems, and superior hardware. The result is windows that provide 30-40 years of service with minimal maintenance. For Irving homeowners who prioritize quality and longevity, wood clad windows offer unmatched value despite higher initial costs.",
      },
      {
        heading: 'Investment in Home Value',
        content: "Wood clad windows significantly enhance home value and appeal in Irving\&apos;s corporate real estate market. The natural wood interior creates warmth and character that buyers value, while the low-maintenance exterior appeals to practical considerations. Wood clad windows are often cited as a key selling feature in premium Irving properties.",
      },
    ],
    ...
    brands: [
      ...
      },
      {
        ...
        description: 'Pella\&apos;s wood clad windows combine authentic wood beauty with their proprietary EnduraClad protection system. The result is windows that perform beautifully in Irving\&apos;s challenging climate while maintaining traditional appeal.',
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'Yes, wood clad windows are highly energy efficient. Wood\&apos;s natural insulating properties combined with modern glass technology can reduce energy costs by 30-40% in Irving\&apos;s climate.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Absolutely. Wood clad window interiors accept any stain or paint, allowing perfect color matching with your Irving home\&apos;s interior design. Many homeowners change interior finishes over time.',
      },
      {
