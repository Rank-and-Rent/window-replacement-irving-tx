...
export const metadata: Metadata = {
  ...
  description: 'Professional window replacement throughout Bedford, TX. Serving all Bedford neighborhoods. Andersen, Pella & Jeld-Wen authorized dealer. Expert service: 972-284-7995',
}
