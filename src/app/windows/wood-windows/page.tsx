...
export const metadata: Metadata = {
  ...
  description: 'Premium solid wood replacement windows in Irving, TX. Timeless natural beauty, superior craftsmanship, and authentic character. Everything priced including installation.',
  keywords: 'wood windows Irving TX, solid wood windows, traditional wood windows, authentic wood windows, custom wood windows',
}

export default function WoodWindowsPage() {
  const content = {
    title: 'Wood Windows Replacement in Irving, TX',
    subtitle: 'Timeless Beauty and Authentic Craftsmanship in Solid Wood',
    heroImage: '/window-types/wood-irving-tx.jpg',

    intro: "Irving homeowners who appreciate authentic traditional craftsmanship and timeless natural beauty choose solid wood windows. Nothing matches the warmth, character, and architectural authenticity that genuine wood provides. For historic Irving homes and discerning homeowners who prioritize traditional quality, solid wood windows offer unparalleled beauty and lasting value.",
    ...
    brands: [
      {
        ...
        description: 'Andersen\&apos;s traditional wood line offers authentic wood windows crafted from premium species with time-honored construction methods. Their windows combine historical accuracy with modern performance features for discerning Irving homeowners.',
      },
      {
        name: 'Pella Wood Windows',
        description: 'Pella crafts solid wood windows using premium wood species and advanced preservation treatments. Their wood windows provide authentic beauty with enhanced longevity, perfect for Irving\&apos;s historic homes and traditional architecture.',
      },
      {
        name: 'JELD-WEN Premium Wood Collection',
        description: 'JELD-WEN\&apos;s premium wood windows feature authentic construction using select wood species. Their AuraLast preservation system extends wood life while maintaining traditional appearance, ideal for Irving\&apos;s climate.',
      },
    ],
    ...
    faq: [
      {
        ...
        answer: 'Yes, solid wood windows require regular maintenance. Exterior surfaces need repainting or refinishing every 3-5 years in Irving\&apos;s climate to prevent moisture damage and UV degradation. However, many homeowners find this maintenance rewarding.',
      },
      {
        question: 'How long do wood windows last?',
        answer: 'With proper maintenance, quality wood windows last 50-100 years or more. They can be refinished repeatedly, allowing homeowners to refresh appearance without replacement. Many Irving homes feature original wood windows from the 1920s-1940s.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Many Irving historic districts require wood windows to maintain period authenticity. Even when not mandated, wood windows are essential for authentic historic preservation and maintaining property value in historic neighborhoods.',
      },
      {
