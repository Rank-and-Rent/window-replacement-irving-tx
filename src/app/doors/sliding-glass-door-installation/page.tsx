    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-stone-100">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-12">
          <h2 className="text-heading-serif text-3xl md:text-4xl text-charcoal-900 font-light mb-10">Sliding Glass Door questions Irving homeowners ask</h2>
          <div className="space-y-8">
            <div>
              <h3 className="text-lg font-medium text-charcoal-900 mb-3">How do sliding glass doors fit my Irving home?</h3>
              <p className="text-charcoal-600 leading-relaxed">Sliding glass doors are space-efficient and ideal for Irving great rooms with limited swing clearance. The default in Valley Ranch and Plymouth Park back-of-house openings, sliding glass doors are usually the right call when the homeowner wants a meaningful upgrade in performance, security, or aesthetic. We bring sample slabs, frame profiles, and hardware finishes to the consultation so you can compare options against your existing trim and millwork before deciding.</p>
            </div>
            <div>
