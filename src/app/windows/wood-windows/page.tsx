  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-12">
          <h2 className="text-heading-serif text-3xl md:text-4xl text-charcoal-900 font-light mb-8">Wood windows installation across Irving</h2>
          <p className="text-charcoal-600 leading-relaxed mb-4">We install wood windows across every Irving neighborhood &mdash; the established Plymouth Park ranches and the older Heritage District blocks south of MacArthur Boulevard, the Las Colinas mid-rise condos around Lake Carolyn and Mandalay Canal, the Valley Ranch family homes east of MacArthur, the Cottonwood Valley and Hackberry Creek custom estates, and the newer townhomes along the SH-161 corridor near DFW Airport. Each housing era brings its own set of measurement, structural, and aesthetic considerations.</p>
          <p className="text-charcoal-600 leading-relaxed mb-4">Our installers complete factory training for Andersen, Pella, JELD-WEN, and Marvin wood windows configurations. That training matters because each manufacturer has distinct requirements for shimming, fastener schedule, foam type, sealant compatibility, and flashing tape. A unit installed using the wrong manufacturer&apos;s technique will look fine for a few summers and then start to leak.</p>
          <p className="text-charcoal-600 leading-relaxed">Most Irving whole-home wood windows replacement projects run two to three working days. Floors get rosin paper, furniture covered in 6-mil plastic, dust collection on every indoor cut, HEPA vacuum at the end of each shift. The final walkthrough happens with you alongside the lead installer, every sash demonstrated, every warranty registered before we leave.</p>
        </div>
      </section>
