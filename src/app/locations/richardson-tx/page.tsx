...
export const metadata: Metadata = {
  ...
  description: 'Professional window replacement throughout Richardson, TX. Serving all Richardson neighborhoods. Andersen, Pella & Jeld-Wen windows. Expert service: 972-284-7995',
}
