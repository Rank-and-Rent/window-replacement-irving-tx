...
export const metadata: Metadata = {
  ...
  description: 'Professional window replacement throughout Coppell, TX. Serving all Coppell neighborhoods. Andersen, Pella & Jeld-Wen windows. Expert service: 972-284-7995',
}
