    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-stone-100 py-4 pt-32">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <ol className="flex items-center space-x-2 text-sm text-charcoal-600">
            ...
            <li className="text-charcoal-400">/</li>
            <li className="text-charcoal-900">JELD-WEN Windows & Doors</li>
          </ol>
        </div>
      </nav>
      ...
      <section className="py-20 bg-stone-100">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 text-center">
          <div className="mb-8">
            <img
              src="/brands/jeld-wen-windows-irving-tx.jpg"
          ...
          <p className="text-charcoal-600 text-xl max-w-2xl mx-auto">
            Premium JELD-WEN Installation in Irving, TX
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <h2 className="text-heading-serif text-3xl md:text-4xl text-charcoal-900 font-light text-center mb-16">
            Why Choose JELD-WEN for Your Irving Home
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-charcoal-600 text-sm leading-relaxed">
                JELD-WEN windows and doors feature advanced insulation technology to keep your Irving home comfortable year-round while reducing energy costs.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-charcoal-600 text-sm leading-relaxed">
                Built to withstand Texas weather, JELD-WEN products resist fading, warping, and deterioration even in Irving&apos;s intense sun and humidity.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-charcoal-600 text-sm leading-relaxed">
                With numerous styles, colors, and finishes available, JELD-WEN offers design options that perfectly complement your Irving home&apos;s architecture.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-charcoal-600 text-sm leading-relaxed">
                Our certified installers are trained in JELD-WEN best practices, ensuring your windows and doors perform optimally for decades.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-stone-100">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <h2 className="text-heading-serif text-3xl md:text-4xl text-charcoal-900 font-light text-center mb-16">
            Frequently Asked Questions About JELD-WEN in Irving, TX
          </h2>
      ...
      <section className="py-24 md:py-32 bg-charcoal-500">
        <div className="max-w-[800px] mx-auto px-6 text-center">
          <h2 className="text-heading-serif text-3xl md:text-4xl text-white font-light mb-6 leading-relaxed">
            Ready to install JELD-WEN windows and doors in Irving?
          </h2>
          <p className="text-stone-300 text-base mb-10">
            Get a free consultation and quote for your JELD-WEN installation project.
          </p>
