    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="space-y-8 max-w-[900px] mx-auto">
            ...
            <div>
              ...
              <p className="text-charcoal-600 text-sm leading-relaxed">
                Entry door costs with installation in Irving, TX vary widely based on material, size, brand, and features. Everything is priced including installation. Basic steel doors start around $800 to $1,200 with installation. Quality fiberglass doors typically range from $1,500 to $3,500 with installation. Premium wood or custom doors can range from $3,000 to $8,000 or more with installation. We do not sell entry doors without installation.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-stone-100">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-12">
          <h2 className="text-heading-serif text-3xl md:text-4xl text-charcoal-900 font-light mb-10">Entry Door questions Irving homeowners ask</h2>
          <div className="space-y-8">
            <div>
              <h3 className="text-lg font-medium text-charcoal-900 mb-3">How do entry doors fit my Irving home?</h3>
              <p className="text-charcoal-600 leading-relaxed">The entry door is the highest-impact single curb-appeal element of any Irving home. Critical for Irving homes where the front elevation faces afternoon sun or HOA review, entry doors are usually the right call when the homeowner wants a meaningful upgrade in performance, security, or aesthetic. We bring sample slabs, frame profiles, and hardware finishes to the consultation so you can compare options against your existing trim and millwork before deciding.</p>
            </div>
            <div>
