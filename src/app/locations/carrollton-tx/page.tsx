...
export const metadata: Metadata = {
  ...
  description: 'Professional window replacement throughout Carrollton, TX. Serving all Carrollton neighborhoods. Andersen, Pella & Jeld-Wen authorized dealer. Expert service: 972-284-7995',
}
