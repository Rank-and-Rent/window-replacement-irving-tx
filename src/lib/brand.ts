...
export function getBrand() {
  return {
    ...
    logo_url: `${CANONICAL_URL}replacement-windows-irving-tx-logo.png`,
    ...
    brand_tagline: 'Premium Window & Door Installation in Irving, TX',
    supportPhone: PHONE,
    supportEmail: EMAIL,
    service_area: 'Serving Irving and the Greater DFW Metroplex',
  };
}
