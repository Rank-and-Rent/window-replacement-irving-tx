    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-stone-100">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-12">
          <h2 className="text-heading-serif text-3xl md:text-4xl text-charcoal-900 font-light mb-10">Custom Door questions Irving homeowners ask</h2>
          <div className="space-y-8">
            <div>
              <h3 className="text-lg font-medium text-charcoal-900 mb-3">How do custom doors fit my Irving home?</h3>
              <p className="text-charcoal-600 leading-relaxed">Custom doors fit non-standard openings, radius geometry, and the architectural specifics of higher-end Irving homes. Common for Las Colinas Country Club, Hackberry Creek, and Cottonwood Valley custom builds, custom doors are usually the right call when the homeowner wants a meaningful upgrade in performance, security, or aesthetic. We bring sample slabs, frame profiles, and hardware finishes to the consultation so you can compare options against your existing trim and millwork before deciding.</p>
            </div>
            <div>
