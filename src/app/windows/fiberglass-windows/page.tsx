  ...
  const content = {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Modern fiberglass windows replicate the natural beauty of wood with stunning accuracy, yet require none of the maintenance that authentic wood demands in Irving\&apos;s climate. Advanced manufacturing creates wood-grain textures virtually indistinguishable from real wood, perfect for Irving\&apos;s historic neighborhoods while eliminating annual refinishing requirements.",
      },
      {
        heading: 'Moisture Resistance for Texas Climate',
        content: "Fiberglass is inherently moisture-resistant, making it perfect for Irving\&apos;s humid summers and occasional heavy rains. Unlike wood that absorbs moisture and rots, fiberglass remains impervious to water damage. The material never needs sealing or protective treatments, preventing mold and mildew growth that can compromise indoor air quality.",
      },
      {
        heading: 'Design Flexibility and Customization',
        content: "Fiberglass\&apos;s workability allows manufacturers to create virtually any window style, size, or configuration. The material accommodates complex curves and irregular shapes that would be difficult with other materials. Available in unlimited color options, fiberglass windows match Irving\&apos;s diverse architectural styles from traditional ranch homes to contemporary designs.",
      },
      {
        heading: 'Environmental and Health Advantages',
        content: "Fiberglass represents a responsible choice for environmentally conscious Irving homeowners. The material is 100% recyclable and requires no toxic preservatives. Long service life means fewer replacements over time, reducing manufacturing impacts. For families concerned about health and environmental impact, fiberglass windows provide premium performance with lower ecological footprint.",
      },
    ],
    ...
    faq: [
      {
        ...
        answer: 'Fiberglass is stronger than any other window frame material. It exceeds steel in tensile strength while maintaining flexibility, making it ideal for large installations and impact-prone areas in Irving.',
      },
      {
        question: 'Are fiberglass windows energy efficient?',
        answer: 'Extremely. Fiberglass\&apos;s low thermal conductivity creates superior insulation. Combined with advanced glass packages, fiberglass windows can reduce energy costs by 35-45% in Irving\&apos;s climate.',
      },
      {
